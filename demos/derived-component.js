...
class DerivedBoxComponent extends HTMLElement {
  ...
  __htmsDefineInputProperty(propName, attributeName, type) {
    ...
    if (this.hasAttribute(attributeName)) {
      this.__htmsProps[propName] = this.__htmsDeserializeAttribute(type, this.getAttribute(attributeName));
      return;
    }
  ...
  constructor() {
    ...
    this.__htmsRenderCleanups = [];
    this.__htmsDefineStateProperty('items');
...
if (!customElements.get('derived-box')) {
